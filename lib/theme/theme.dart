...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xff506628),
      surfaceTint: Color(0xff506628),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xffd2ec9f),
      onPrimaryContainer: Color(0xff394d12),
      secondary: Color(0xff596248),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xffdde6c6),
      onSecondaryContainer: Color(0xff424a32),
      ...
      onPrimaryFixedVariant: Color(0xff394d12),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      brightness: Brightness.light,
      primary: Color(0xff293c02),
      surfaceTint: Color(0xff506628),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff5e7535),
      onPrimaryContainer: Color(0xffffffff),
      secondary: Color(0xff313922),
      onSecondary: Color(0xffffffff),
      ...
      secondaryFixedDim: Color(0xff50583f),
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff48756f),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff22514c),
      onTertiaryContainer: Color(0xffffffff),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xff394d12),
      ...
      inversePrimary: Color(0xff506628),
      primaryFixed: Color(0xffd2ec9f),
      onPrimaryFixed: Color(0xff131f00),
      primaryFixedDim: Color(0xffb6d086),
      onPrimaryFixedVariant: Color(0xff394d12),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      primaryFixedDim: Color(0xffb6d086),
      onPrimaryFixedVariant: Color(0xff293c02),
      secondaryFixed: Color(0xffdde6c6),
      ...
      surfaceContainerHighest: Color(0xff3d3f36),
    );
  }
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      brightness: Brightness.dark,
      primary: Color(0xffdffaac),
      surfaceTint: Color(0xffb6d086),
      onPrimary: Color(0xff000000),
      primaryContainer: Color(0xffb2cc82),
      ...
      secondaryFixedDim: Color(0xffc1caab),
      onSecondaryFixedVariant: Color(0xff0d1303),
      tertiaryFixed: Color(0xffbcece5),
